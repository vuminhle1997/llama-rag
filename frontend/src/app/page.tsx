        ...
        <main className="flex flex-grow">
          ...
          <div className="flex w-1/2 flex-col items-center justify-center bg-gray-400/10">
            <div className="text-center">
              ...
              />
              <div className="mt-8">
              <h1 className="mb-3 text-4xl font-bold text-foreground animate-fade-in">Global CT InsightChat</h1>
              <p className="mb-6 text-xl text-muted-foreground animate-fade-in">Unleashing Intelligence Through Data-Driven Conversations</p>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4">
            <div className="flex flex-col items-center justify-between space-y-4 sm:flex-row sm:space-y-0">
              <div className="text-sm text-muted-foreground">
                © {new Date().getFullYear()} LlamaRAG. All rights reserved.
              </div>
  ...
  return (
    <main className="flex-1 overflow-auto">
          <div className="container mx-auto py-10">
            <h1 className="text-3xl font-bold">Global CT InsightChat</h1>
          </div>
        </main>
  )
}
